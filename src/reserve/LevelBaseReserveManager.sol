...
import {ERC20Wrapper} from "../WrappedRebasingERC20.sol";

import "@openzeppelin/contracts/utils/ReentrancyGuard.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import {Math} from "@openzeppelin/contracts/utils/math/Math.sol";
import {SafeCast} from "@openzeppelin/contracts/utils/math/SafeCast.sol";
import {Pausable} from "@openzeppelin-4.9.0/contracts/security/Pausable.sol";
    ...
    Pausable
{
    ...
    /**
     * @notice Rewards staked lvlUSD with lvlUSD. The REWARDER_ROLE should call
     * mint lvlUSD before calling this function
     * @param amount amount of lvlUSD to reward
     * @dev only callable by rewarder
     */
