...
import {DataTypes} from "@level/src/v1/interfaces/aave/DataTypes.sol";
import {IPoolAddressesProvider} from "@level/src/v1/interfaces/aave/IPoolAddressesProvider.sol";
...
contract MockAaveV3Pool is IPool {
    ...
    mapping(address => DataTypes.UserConfigurationMap) private userConfigurations;
    ...
    function initReserve(address asset, string memory aTokenName) external {
        ...
        MockAToken aToken = new MockAToken(aTokenName, "AToken", ERC20(asset).decimals());
        ...
        external
    {
        ...
        emit Borrow(
            asset, onBehalfOf, onBehalfOf, amount, DataTypes.InterestRateMode(interestRateMode), 0, referralCode
        );
    }
    ...
    function repay(address asset, uint256 amount, uint256 interestRateMode, address onBehalfOf)
        ...
        returns (uint256)
    {
        uint256 repayAmount = amount > userBorrows[onBehalfOf][asset] ? userBorrows[onBehalfOf][asset] : amount;
