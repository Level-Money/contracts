...
contract ReserveBaseSetup is Test, IlvlUSDDefinitions {
    ...
    function setUp() public virtual {
        ...
        aDAI = MockAToken(mockAavePool.getReserveData(address(DAIToken)).aTokenAddress);
        waUSDC = new WrappedRebasingERC20(IERC20(address(aUSDC)), "waUSDC", "waUSDC");
        waDAI = new WrappedRebasingERC20(
            IERC20(mockAavePool.getReserveData(address(DAIToken)).aTokenAddress), "waDAI", "waDAI"
        );
