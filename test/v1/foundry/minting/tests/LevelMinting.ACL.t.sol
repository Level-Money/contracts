...
import "@level/src/v1/interfaces/ISingleAdminAccessControl.sol";
import {LevelMinting} from "@level/src/v1/LevelMinting.sol";
...
contract LevelMintingACLTest is LevelMintingUtils {
    ...
    function test_owner_canTransfer_reserve() public {
        ...
        LevelMintingContract.transferToReserve(beneficiary, address(DAIToken), 1000);
        assertEq(DAIToken.balanceOf(beneficiary), 1000);
        assertEq(DAIToken.balanceOf(address(LevelMintingContract)), 0);
    }

    function test_fuzz_nonAdmin_cannot_transferReserve_revert(address nonAdmin) public {
    ...
    function test_gatekeeper_cannot_add_minters_revert() public {
        ...
        assertFalse(LevelMintingContract.hasRole(minterRole, bob), "Bob should lack the minter role");
    }
    ...
    function test_gatekeeper_can_disable_mintRedeem() public {
        ...
        assertEq(LevelMintingContract.maxMintPerBlock(), 0, "Minting should be disabled");
        assertEq(LevelMintingContract.maxRedeemPerBlock(), 0, "Redeeming should be disabled");
    }
    ...
    function test_admin_can_disable_mint(bool performCheckMint) public {
        ...
        assertEq(LevelMintingContract.maxMintPerBlock(), 0, "The minting should be disabled");
    }
    ...
    function test_admin_can_disable__redeem(bool performCheckRedeem) public {
        ...
        assertEq(LevelMintingContract.maxRedeemPerBlock(), 0, "The redeem should be disabled");
    }
    ...
    function test_admin_can_enable_mint() public {
        ...
        assertTrue(LevelMintingContract.maxMintPerBlock() > 0, "The minting should be enabled");
    }
    ...
    function test_fuzz_nonAdmin_cannot_enable_mint_revert(address notAdmin) public {
        ...
        assertEq(LevelMintingContract.maxMintPerBlock(), 0, "The minting should remain disabled");
    }
    ...
    function test_fuzz_nonAdmin_cannot_enable_redeem_revert(address notAdmin) public {
        ...
        assertEq(LevelMintingContract.maxRedeemPerBlock(), 0, "The redeeming should remain disabled");
    }
    ...
    function test_admin_can_enable__redeem() public {
        ...
        assertTrue(LevelMintingContract.maxRedeemPerBlock() > 0, "The redeeming should be enabled");
    }
    ...
    function test_admin_can_add_gatekeeper() public {
        ...
        assertTrue(LevelMintingContract.hasRole(gatekeeperRole, bob), "Bob should have the gatekeeper role");
        vm.stopPrank();
    }
    ...
    function test_admin_can_remove_gatekeeper() public {
        ...
        assertFalse(LevelMintingContract.hasRole(gatekeeperRole, bob), "Bob should no longer have the gatekeeper role");
    ...
    function test_fuzz_notAdmin_cannot_remove_gatekeeper(address notAdmin) public {
        ...
        assertTrue(LevelMintingContract.hasRole(gatekeeperRole, bob), "Bob should maintain the gatekeeper role");
    ...
    function test_fuzz_notAdmin_cannot_add_gatekeeper(address notAdmin) public {
        ...
        assertFalse(LevelMintingContract.hasRole(gatekeeperRole, bob), "Bob should lack the gatekeeper role");
