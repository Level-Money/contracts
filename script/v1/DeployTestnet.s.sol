...
import "@level/src/v1/interfaces/ILevelMinting.sol";
import "@level/src/v1/interfaces/IStakedlvlUSD.sol";
...
contract DeployTestnet is Script, DeploymentUtils {
    ...
    address public constant SEPOLIA_AAVE_USDT = 0xaA8E23Fb1079EA71e0a56F48a2aA51851D8433D0;

    address public constant SEPOLIA_USDC = 0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238;

    address public constant SEPOLIA_ADMIN = 0x74C3dC2F48b9cc5f167B0C8AE09FbbDc6315f519;

    address public constant SEPOLIA_CUSTODIAN = 0x74C3dC2F48b9cc5f167B0C8AE09FbbDc6315f519;

    address public constant SEPOLIA_AAVE_POOL_PROXY = 0x6Ae43d3271ff6888e7Fc43Fd7321a503ff738951;
    ...
    function deployment(uint256 deployerPrivateKey) public returns (Contracts memory) {
        ...
        contracts.stakedlvlUSD =
            new StakedlvlUSD(IERC20v4(address(contracts.levelUSDToken)), SEPOLIA_ADMIN, SEPOLIA_ADMIN);
        ...
        // StakedlvlUSD
        contracts.stakedlvlUSD = new StakedlvlUSD(contracts.levelUSDToken, SEPOLIA_ADMIN, SEPOLIA_ADMIN);
        ...
        console.log(
            "Level Minting                  : https://sepolia.etherscan.io/address/%s", address(contracts.levelMinting)
        );
        // console.log(
